...
public class WarrantyCoolerTest
{
    private readonly ComputerDirector _computerDirector;
    public WarrantyCoolerTest()
    {
        ...
        cpuBuilder2.SetName("Intel Core i5 11400F")
        ...
        cpuBuilder3.SetName("Intel Core i7 11400F")
            .SetSocketType(new Socket("Intel LGA 1200"))
            .SetFrequency(2.6)
            .SetCoreCount(6)
            .SetTdp(150)
    ...
    [Theory]
    [InlineData("Thermaltake Engine 17", "Intel Core i5 11400F")]
    [InlineData("Thermaltake Engine 17", "Intel Core i7 11400F")]
    [InlineData("Deepcool GAMMAXX 300", "Intel Core i7 11400F")]
    public void WarrantyCooler(string coolerName, string cpuName)
    {
        GetDefaultDirector();
        _computerDirector.SetCooler(coolerName)
            .SetCpu(cpuName);
